...
class AppBootstrapper {
    ...
    @Inject
    public void getProperties(PulseProperties properties) {
    ...
    private File getPIDFile() {
        final String pidPath = properties.PulsePIDPath + "/pulse.pid";
    ...
    private void init() {
        logger.info("Initializing internall bootstrapper configurations.");
        pidFile = getPIDFile();
