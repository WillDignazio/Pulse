...
public class DefaultIndexer implements ServerIndexer {
    private static final Logger logger = LogManager.getLogger(DefaultIndexer.class);
    private final IndexConduit indexConduit;
    private final StorageConduit storageConduit;

    @Inject
    public DefaultIndexer(IndexConduit indexConduit, StorageConduit storageConduit) {
